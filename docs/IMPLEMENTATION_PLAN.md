...
| 工作区 | tracked/untracked/ignored 状态、整文件暂存、分组批量暂存/取消暂存、选中“文件状态”时完整展示工作区文件、Diff 和提交入口 | hunk/行级暂存、过滤、丢弃预览 | sparse checkout 增强 |
...
- 仓库收藏、工作区分组和首页管理操作。
- hunk/行级暂存。
- Tag、独立 Rebase、Cherry-pick、Revert、Reset。
- 历史搜索、左右 Diff、基础冲突处理。
