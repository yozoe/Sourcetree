...
| 桌面集成 | 快捷键、深浅主题、原生仓库/动作/窗口菜单（动作菜单已支持系统打开、Finder、Terminal 和 Quick Look；窗口菜单已支持填充、居中、靠左/靠右、动态跨显示器移动、合并标签循环切换/移出和标签栏显隐；全屏平铺、多个持久化窗口组与标签总览待实现） | 中英文、自定义终端、外部 Diff/Merge、自动更新 | Windows/Linux 原生集成 |
