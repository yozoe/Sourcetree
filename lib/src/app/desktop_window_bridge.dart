...
final class DesktopWindowBridge {
  ...
  static Future<void> setWorkspaceMenuState({
    ...
    required bool canAbortOperation,
    ...
    required bool canCopySelected,
    required bool canMoveSelected,
    required bool canUseConflictStage2,
    required bool canUseConflictStage3,
    required bool canFetch,
    required bool canInteractiveRebase,
    required bool canIgnoreSelected,
    required bool canMerge,
    required bool canPull,
    required bool canPush,
    required bool canReviewSelected,
    required bool canRemoveSelected,
    required bool canResetRepository,
    required bool canResetSelected,
    required bool canResetToSelectedCommit,
    ...
    required bool canViewSelectedFileHistory,
    required String? activeRepositoryOperation,
    required String conflictStage2Label,
    required String conflictStage3Label,
    ...
    return _channel
        .invokeMethod<void>('setWorkspaceMenuState', <String, Object?>{
          ...
          'conflictStage2Label': conflictStage2Label,
          'conflictStage3Label': conflictStage3Label,
